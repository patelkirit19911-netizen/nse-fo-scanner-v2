...
def get_nifty_stocks():
    ...
    "TITAN","BAJFINANCE","ULTRACEMCO","NTPC","POWERGRID",
    "M&M","TATAMOTORS","HCLTECH","WIPRO","TECHM",
    "ADANIPORTS","INDUSINDBK","NESTLEIND","BAJAJFINSV",
    "TATASTEEL","JSWSTEEL","ONGC","COALINDIA","GRASIM",
    "CIPLA","EICHERMOT","DRREDDY","APOLLOHOSP",
